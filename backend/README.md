...
Server will start at: `https://microlearnignbackend.vercel.app/`
...
### Base URL
```
https://microlearnignbackend.vercel.app/api/v1
```
...
### Health Check
```bash
GET https://microlearnignbackend.vercel.app/health
...
curl -X GET https://microlearnignbackend.vercel.app/api/v1/certificates/verify/ABC123XYZ456...
...
1. **Register a user**
```bash
curl -X POST https://microlearnignbackend.vercel.app/api/v1/auth/register \
...
2. **Login**
```bash
curl -X POST https://microlearnignbackend.vercel.app/api/v1/auth/login \
  -H "Content-Type: application/json" \
  -d '{
    "email": "test@example.com",
    "password": "password123"
...
```bash
curl -X GET https://microlearnignbackend.vercel.app/api/v1/protected-route \
