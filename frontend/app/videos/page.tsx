      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex items-center gap-3 sm:gap-4 mb-3">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-600 mt-0.5">Discover educational videos tailored for you</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-4 mt-4">
            <div className="bg-white rounded-xl border-2 border-green-100 p-3 sm:p-4 text-center hover:shadow-lg transition-all">
              ...
              <p className="text-[10px] sm:text-xs text-gray-600 font-medium mt-1">Videos</p>
            </div>
            <div className="bg-white rounded-xl border-2 border-teal-100 p-3 sm:p-4 text-center hover:shadow-lg transition-all">
              ...
              <p className="text-[10px] sm:text-xs text-gray-600 font-medium">YouTube</p>
            </div>
            <div className="bg-white rounded-xl border-2 border-emerald-100 p-3 sm:p-4 text-center hover:shadow-lg transition-all">
              ...
              <p className="text-[10px] sm:text-xs text-gray-600 font-medium">Curated</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSearch} className="mb-6">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-24 sm:pr-32 py-3 sm:py-4 bg-white border-2 border-gray-200 rounded-xl text-gray-800 placeholder-gray-400 focus:border-green-500 focus:ring-4 focus:ring-green-100 transition-all outline-none text-sm sm:text-base"
            />
            <button
              type="submit"
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <button
            ...
            className="md:hidden w-full bg-white border-2 border-gray-200 rounded-xl p-3 mb-3 flex items-center justify-between font-semibold text-gray-700 hover:bg-gray-50 transition-all"
          >
            <span className="flex items-center gap-2">
              <Filter className="w-5 h-5 text-green-600" />
              Categories
            </span>
            {showMobileFilters ? <X className="w-5 h-5" /> : <span className="text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full">{categories.length}</span>}
          </button>
            ...
            {categories.map((category) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-5 py-3 font-semibold rounded-xl transition-all whitespace-nowrap ${
              ...
              {categories.map((category) => {
                ...
                return (
                  <button
                    key={category.id}
                    onClick={() => handleCategoryClick(category.id)}
                    className={`flex items-center gap-2 px-4 py-3 font-semibold rounded-xl transition-all text-sm ${
                      selectedCategory === category.id
        ...
        {youtubeVideos.length === 0 ? (
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl border-2 border-gray-100 p-8 sm:p-16 text-center">
            <div className="relative mb-6">
              <div className="w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-br from-green-100 to-teal-100 rounded-full flex items-center justify-center mx-auto">
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3">Loading Recommended Videos...</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {youtubeVideos.map((video) => (
                <div
                  ...
                  className="bg-white rounded-xl sm:rounded-2xl shadow-lg border-2 border-gray-100 overflow-hidden hover:shadow-2xl hover:scale-[1.02] transition-all cursor-pointer group"
                >
                  {/* Thumbnail */}
                  ...
                  <div className="p-4 sm:p-5">
                    <h3 className="font-bold text-gray-900 text-sm sm:text-base line-clamp-2 mb-2 group-hover:text-green-600 transition-colors">
                      {video.title}
                    </h3>
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <p className="text-xs sm:text-sm text-gray-600 font-medium truncate flex-1">{video.channelTitle}</p>
                    </div>
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                      ...
                      <button className="flex items-center gap-1 text-[10px] sm:text-xs font-semibold text-green-600 hover:text-green-700 transition-colors">
        ...
        {selectedYoutubeVideo && showVideoPlayer && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-75 animate-in fade-in duration-300">
            <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl w-full max-w-5xl max-h-[95vh] overflow-hidden animate-in zoom-in-95 duration-300">
              {/* Modal Header */}
              ...
              <div className="p-4 sm:p-6 max-h-48 overflow-y-auto">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-semibold text-sm sm:text-base text-gray-900 truncate">{selectedYoutubeVideo.channelTitle}</p>
                    <div className="flex items-center gap-2 text-xs sm:text-sm text-gray-500">
                ...
                <div className="bg-gradient-to-br from-gray-50 to-green-50 rounded-xl p-3 sm:p-4 border border-gray-100">
