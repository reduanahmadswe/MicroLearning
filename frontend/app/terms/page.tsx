        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl border border-gray-100 overflow-hidden mb-8">
          ...
          <div className="p-6 sm:p-8 bg-green-50 border-b border-green-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
              <a href="#acceptance" className="text-sm text-green-600 hover:text-green-700 hover:underline">1. Acceptance of Terms</a>
              <a href="#eligibility" className="text-sm text-green-600 hover:text-green-700 hover:underline">2. Eligibility</a>
              <a href="#account" className="text-sm text-green-600 hover:text-green-700 hover:underline">3. User Accounts</a>
              <a href="#conduct" className="text-sm text-green-600 hover:text-green-700 hover:underline">4. User Conduct</a>
              <a href="#content" className="text-sm text-green-600 hover:text-green-700 hover:underline">5. Content & Intellectual Property</a>
              <a href="#termination" className="text-sm text-green-600 hover:text-green-700 hover:underline">6. Termination</a>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl border border-gray-100 p-6 sm:p-12 space-y-8">
          ...
          <section id="account">
            ...
            <div className="pl-16 space-y-4 text-gray-600">
              ...
              <h3 className="font-semibold text-gray-800 mt-6">Account Termination</h3>
              <p>
          ...
          <section id="content">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-800">5. Content & Intellectual Property</h2>
              </div>
            </div>
            <div className="pl-16 space-y-4 text-gray-600">
              <h3 className="font-semibold text-gray-800">Platform Content</h3>
              <p>
              ...
              <h3 className="font-semibold text-gray-800 mt-6">User-Generated Content</h3>
              <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-800 mb-4">8. Changes to Service</h2>
            <div className="text-gray-600 space-y-4">
              <p>
          ...
          <section>
            ...
            <div className="text-gray-600 space-y-4">
              ...
              <div className="bg-green-50 border-2 border-green-200 rounded-xl p-4 sm:p-6">
                <p className="font-semibold text-gray-800">MicroLearning Support</p>
                <p>Email: <a href="mailto:legal@microlearning.com" className="text-green-600 hover:underline">legal@microlearning.com</a></p>
