  ...
  return (
    <div className="min-h-screen w-full bg-page-gradient">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <Link
          href="/auth/register"
          className="inline-flex items-center gap-2 text-green-600 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300 font-medium mb-6 hover:underline"
        >
        ...
        {/* Page Header */}
        <div className="bg-card rounded-2xl sm:rounded-3xl shadow-xl border border-border overflow-hidden mb-8">
          ...
          {/* Quick Navigation */}
          <div className="p-6 sm:p-8 bg-green-50 dark:bg-green-900/10 border-b border-border">
            <h2 className="font-bold text-foreground mb-3">Quick Navigation</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
              <a href="#collection" className="text-sm text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 hover:underline">1. Information Collection</a>
              <a href="#usage" className="text-sm text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 hover:underline">2. How We Use Your Data</a>
              <a href="#sharing" className="text-sm text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 hover:underline">3. Information Sharing</a>
              <a href="#security" className="text-sm text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 hover:underline">4. Data Security</a>
              <a href="#cookies" className="text-sm text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 hover:underline">5. Cookies & Tracking</a>
              <a href="#rights" className="text-sm text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 hover:underline">6. Your Rights</a>
            </div>
          </div>
        </div>

        {/* Privacy Content */}
        <div className="bg-card rounded-2xl sm:rounded-3xl shadow-xl border border-border p-6 sm:p-12 space-y-8">
          {/* Introduction */}
          <section>
            <div className="bg-blue-50 dark:bg-blue-900/10 border-l-4 border-blue-500 p-4 sm:p-6 rounded-r-xl mb-8">
              <p className="text-muted-foreground">
                At <strong className="text-foreground">MicroLearning</strong>, we are committed to protecting your privacy and ensuring transparency about how we collect, use, and safeguard your personal information. This Privacy Policy explains our practices regarding your data when you use our platform.
              </p>
            </div>
          </section>
          ...
          <section id="collection">
            ...
            <div className="pl-16 space-y-4 text-muted-foreground">
              ...
              <h3 className="font-semibold text-foreground mt-6">Automatically Collected Information</h3>
              <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <section id="sharing">
            ...
            <div className="pl-16 space-y-4 text-muted-foreground">
              ...
              <h3 className="font-semibold text-foreground mt-4">Other Users</h3>
              <p>
          ...
          <section id="security">
            ...
            <div className="pl-16 space-y-4 text-muted-foreground">
              ...
              <div className="bg-yellow-50 dark:bg-yellow-900/10 border-l-4 border-yellow-500 p-4 rounded-r-xl mt-4">
          ...
          <section id="rights">
            ...
            <div className="pl-16 space-y-4 text-muted-foreground">
              ...
              <p className="mt-4">
                To exercise these rights, contact us at <a href="mailto:privacy@microlearning.com" className="text-green-600 dark:text-green-400 hover:underline font-medium">privacy@microlearning.com</a>
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="text-muted-foreground space-y-4">
              ...
              <div className="bg-green-50 dark:bg-green-900/10 border-2 border-green-200 dark:border-green-900/20 rounded-xl p-4 sm:p-6">
                <p className="font-semibold text-foreground">MicroLearning Privacy Team</p>
                <p>Email: <a href="mailto:privacy@microlearning.com" className="text-green-600 dark:text-green-400 hover:underline">privacy@microlearning.com</a></p>
