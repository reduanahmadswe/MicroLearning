      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl shadow-xl border-2 border-gray-100 p-6 sm:p-8">
            <div className="mb-6">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">{selectedRoadmap.title}</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="relative pl-8">
                ...
                {selectedRoadmap.nodes?.map((node, index) => {
                  ...
                  return (
                    <div key={node.id || index} className="relative mb-6 last:mb-0">
                      ...
                      {/* Node Card */}
                      <div className={`ml-6 p-4 rounded-xl border-2 transition-all ${
                        node.isLocked ? 'bg-gray-50 border-gray-200 opacity-60' :
                        node.isCompleted ? 'bg-green-50 border-green-300' :
                ...
                <div className="relative mb-0">
                  ...
                  <div className="ml-6 p-6 rounded-xl border-2 border-yellow-300 bg-gradient-to-br from-yellow-50 to-orange-50 text-center">
                    <Trophy className="w-12 h-12 text-yellow-600 mx-auto mb-3" />
                    <h4 className="text-lg font-bold text-gray-900 mb-2">Roadmap Complete!</h4>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className="flex-1"
                    />
                    <span className="px-4 py-2 bg-green-100 text-green-700 rounded-lg font-bold min-w-[80px] text-center">
