      ...
      <div className="min-h-screen bg-page-gradient flex items-center justify-center p-4">
        <Card className="border-0 shadow-2xl bg-card backdrop-blur-sm">
          <CardContent className="flex flex-col items-center justify-center py-12 sm:py-16 px-6 sm:px-12">
            ...
            <p className="text-muted-foreground font-medium text-sm sm:text-base">Loading your bookmarks...</p>
          </CardContent>
        </Card>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-page-gradient">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 w-64 sm:w-96 h-64 sm:h-96 bg-green-200/30 dark:bg-green-900/10 rounded-full mix-blend-multiply dark:mix-blend-normal filter blur-3xl opacity-30 animate-blob"></div>
        <div className="absolute top-40 right-10 w-64 sm:w-96 h-64 sm:h-96 bg-teal-200/30 dark:bg-teal-900/10 rounded-full mix-blend-multiply dark:mix-blend-normal filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
        <div className="absolute -bottom-8 left-1/2 w-64 sm:w-96 h-64 sm:h-96 bg-emerald-200/30 dark:bg-emerald-900/10 rounded-full mix-blend-multiply dark:mix-blend-normal filter blur-3xl opacity-30 animate-blob animation-delay-4000"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        ...
        <div className="mb-4 sm:mb-6">
          <button
            ...
            className="flex items-center gap-2 text-muted-foreground hover:text-green-600 transition-colors group"
          >
        ...
        {bookmarks.length > 0 && (
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-6 sm:mb-8">
            ...
            {/* Collections */}
            <Card className="border-0 shadow-lg bg-gradient-to-br from-teal-500 to-cyan-600 dark:from-teal-600 dark:to-cyan-700 overflow-hidden group hover:shadow-xl transition-all duration-300">
              <CardContent className="p-4 sm:p-6 relative">
                <div className="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -mr-10 -mt-10 group-hover:scale-110 transition-transform"></div>
                <div className="relative">
                  <div className="flex items-center justify-between mb-2">
            ...
            {/* Total Time */}
            <Card className="border-0 shadow-lg bg-gradient-to-br from-emerald-500 to-green-600 dark:from-emerald-600 dark:to-green-700 overflow-hidden group hover:shadow-xl transition-all duration-300">
              <CardContent className="p-4 sm:p-6 relative">
                <div className="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -mr-10 -mt-10 group-hover:scale-110 transition-transform"></div>
                <div className="relative">
                  <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 sm:py-3 bg-background border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm sm:text-base text-foreground placeholder-muted-foreground"
                />
              </div>
              ...
              <div className="flex gap-2 flex-wrap mt-4">
                {collections.map((collection) => (
                  <Button
                    ...
                    variant="outline"
                    className={`text-xs sm:text-sm ${selectedCollection === collection
                      ? 'bg-green-600 text-white border-green-600 hover:bg-green-700 hover:text-white'
                      : 'hover:bg-accent hover:border-green-200 dark:hover:border-green-800'
                      }`}
                  >
                  ...
                  <div className="flex items-start gap-3 sm:gap-4 mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <Link
                        ...
                        className="text-base sm:text-lg font-bold text-foreground hover:text-green-600 transition-colors line-clamp-2 block mb-2"
                      >
                      ...
                      {bookmark.notes && (
                        <div className="mt-3 p-3 bg-secondary rounded-lg border border-border">
                          <p className="text-xs sm:text-sm text-muted-foreground italic">"{bookmark.notes}"</p>
                        </div>
                      )}
                    </div>
                  ...
                  <div className="flex gap-2 pt-3 border-t border-border">
                    ...
                    {bookmark.lesson.course && (
                      <Link href={`/courses/${bookmark.lesson.course._id}`}>
                        <Button variant="outline" className="border-border hover:bg-accent hover:border-accent text-xs sm:text-sm">
