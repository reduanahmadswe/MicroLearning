                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <Card className="bg-gradient-to-br from-green-600 to-green-700 text-white">
                    <CardContent className="p-6">
                      ...
                      <h3 className="text-white/80 text-sm font-medium mb-2">Total Content</h3>
                      <p className="text-4xl font-bold">{(stats.content?.lessons || 0) + (stats.content?.quizzes || 0) + (stats.content?.courses || 0)}</p>
                      <p className="text-white/70 text-sm mt-2">
                  ...
                  <Card className="bg-gradient-to-br from-purple-600 to-purple-700 text-white">
                    <CardContent className="p-6">
                      ...
                      <h3 className="text-white/80 text-sm font-medium mb-2">Active Users</h3>
                      <p className="text-4xl font-bold">{stats.users?.active || 0}</p>
                      <p className="text-white/70 text-sm mt-2">
                        Last 30 days
                      </p>
                    </CardContent>
                  ...
                  <Card className="bg-gradient-to-br from-orange-600 to-orange-700 text-white">
                    <CardContent className="p-6">
                      ...
                      <h3 className="text-white/80 text-sm font-medium mb-2">Engagement</h3>
                      <p className="text-4xl font-bold">{stats.engagement?.totalQuizAttempts || 0}</p>
                      <p className="text-white/70 text-sm mt-2">
                        Quiz attempts
                      </p>
                    </CardContent>
                          ...
                          <div key={user.userId} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-600">{user.completedLessons} lessons completed</p>
                              </div>
                            </div>
                            <div className="text-right">
                              <p className="text-sm font-semibold text-purple-600">{user.xp} XP</p>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <Card>
                    <CardContent className="p-6">
                      ...
                      <p className="text-sm text-gray-600">Recent Lessons</p>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardContent className="p-6">
                      ...
                      <p className="text-sm text-gray-600">Recent Quizzes</p>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardContent className="p-6">
                      ...
                      <p className="text-sm text-gray-600">Recent Courses</p>
                    </CardContent>
                  </Card>
                </div>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-2">
                        ...
                        )) || <p className="text-center text-gray-500 py-4">No lessons</p>}
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-2">
                        ...
                        )) || <p className="text-center text-gray-500 py-4">No quizzes</p>}
                      </div>
                    </CardContent>
                  </Card>
                </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="grid md:grid-cols-2 gap-3">
                      ...
                      )) || <p className="text-center text-gray-500 py-4 col-span-2">No courses</p>}
                    </div>
                  </CardContent>
                </Card>
              </div>
