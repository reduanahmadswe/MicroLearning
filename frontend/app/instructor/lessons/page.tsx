        ...
        <Card className="bg-card border-border mb-4 sm:mb-6">
          <CardContent className="p-4 sm:p-5 lg:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2 text-sm border-2 border-border rounded-lg bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 placeholder:text-muted-foreground"
                  />
                </div>
              </div>
              ...
              {/* Difficulty Filter */}
              <div>
                <label className="block text-xs sm:text-sm font-medium text-foreground mb-1.5 sm:mb-2">Difficulty</label>
                <select
                  value={difficultyFilter}
                  onChange={(e) => setDifficultyFilter(e.target.value)}
                  className="w-full px-3 py-2 text-sm border-2 border-border rounded-lg bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
                >
              ...
              {/* Quiz Filter */}
              <div>
                <label className="block text-xs sm:text-sm font-medium text-foreground mb-1.5 sm:mb-2">Quiz Status</label>
                <select
                  value={quizFilter}
