...
export default function NestedComment({
  ...
  const indentClass = depth > 0 ? 'ml-8 pl-4 border-l-2 border-border' : '';
        ...
        <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center justify-between mb-1">
              ...
              {isOwner && (
                <div className="relative">
                  ...
                  {showMenu && (
                    <div className="absolute right-0 mt-1 w-32 bg-popover rounded-lg shadow-lg border border-border z-10">
                      <button
                        onClick={() => {
                          setIsEditing(true);
                          setShowMenu(false);
            ...
            {isEditing ? (
              <div className="mt-2">
                <textarea
                  ...
                  className="w-full p-2 border border-input bg-background rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-ring"
                  rows={2}
                  maxLength={2000}
                />
          ...
          <div className="flex items-center gap-4 mt-1 ml-1">
            <button
              ...
              className={`flex items-center gap-1 text-xs ${hasLiked ? 'text-red-600 font-semibold' : 'text-muted-foreground hover:text-red-600'
                } transition-colors`}
            >
            ...
            <div className="mt-3 flex gap-2">
              ...
              <div className="flex-1">
                <textarea
                  ...
                  className="w-full p-2 border border-input bg-background rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-ring resize-none"
                  rows={2}
                  maxLength={2000}
                />
                <div className="flex gap-2 mt-2">
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {comment.replyCount > 0 && " All replies to this comment will also be deleted."}
              <br />
